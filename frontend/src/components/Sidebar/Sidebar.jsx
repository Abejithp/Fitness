...
function Sidebar() {
    ...
    return (
        <div className="flex flex-col gap-4 w-[400px] h-screen p-8 sticky top-0 max-laptop:h-[150px] max-laptop:w-full max-tablet:h-[120px]">
            ...
            <div className={`flex flex-col bg-slate-700 w-full font-satoshi rounded-2xl gap-4 p-8
                           laptop:hidden
